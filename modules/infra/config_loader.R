...
load_plot_config <- function(config_file = NULL) {
  if (is.null(config_file)) {
    local_path <- file.path("config", "plot_defaults.json")
    pkg_path <- system.file("app/config/plot_defaults.json", package = "methodCompare")
